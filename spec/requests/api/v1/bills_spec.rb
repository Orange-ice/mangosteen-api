...
RSpec.describe "Api::V1::Bills", type: :request do
  describe "获取账单" do
    ...
    it "可按时间筛选" do
      user = User.create email: '1@qq.com'
      bill1 = Bill.create amount: 100, user_id: user.id, tag_id: 1, created_at: '2020-01-01'
      bill2 = Bill.create amount: 100, user_id: user.id, tag_id: 1, created_at: '2020-01-05'
      bill3 = Bill.create amount: 100, user_id: user.id, tag_id: 1, created_at: '2020-01-09'
